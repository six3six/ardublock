...
public class GenerateCodeButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Set<RenderableBlock> loopBlockSet = new HashSet<>();
        Set<RenderableBlock> subroutineBlockSet = new HashSet<>();
        Set<RenderableBlock> scoopBlockSet = new HashSet<>();
        Set<RenderableBlock> guinoBlockSet = new HashSet<>();
        ...
        for (RenderableBlock renderableBlock : renderableBlocks) {
            ...
            if (!block.hasPlug() && (Block.NULL.equals(block.getBeforeBlockID()))) {
                ...
                if (genus.equals("loop") || genus.equals("loop1") || genus.equals("loop2") || genus.equals("loop3") || genus.equals("program") || genus.equals("setup")) {
                    loopBlockSet.add(renderableBlock);
                }
                if (genus.equals("subroutine") || genus.equals("subroutine_var")) {
                ...
                if (genus.equals("scoop_task") || genus.equals("scoop_loop") || genus.equals("scoop_pin_event")) {
